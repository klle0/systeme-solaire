...
# Classe Planete
class Planet:
    def __init__(self, nom, color, rayon_x, rayon_y, speed, size, angle_rotation, diametre, population, info=""):
        self.nom = nom
        self.color = color
...
def main():
    ...
    bouton_lire_pause = BoutonMusique(1100, 500, image_lire, image_pause)
    bouton_prec = BoutonMusique(1020, 500, image_prec, image_prec) 
    bouton_suiv = BoutonMusique(1180, 500, image_suiv, image_suiv) 
