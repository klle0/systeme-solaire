...
class Asteroide:
    ...
    def __init__(nombre_asteroides, distance_ceinture, zoom_factor):
        ...
        Asteroide.distance_ceinture = distance_ceinture*zoom_factor
...
def main():
    ...
    while en_cours:
        ...
        Asteroide.dessiner_ceinture_asteroides(window, (centre_x, centre_y), 0.002*zoom_factor, pause)
        ...
        if zoom_active:
            ...
            Asteroide.dessiner_ceinture_asteroides(zoomed_surface, (centre_x, centre_y), 0.002,zoom_factor, pause)
